...
public class updateData extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Update a Details to data base ");
...
//        }
        ...
        String quary ="update `crudtable` set `name`=?,`gender`=?,`plase`=?,`language`=?,`qulification`=?,`gmail`=?,`birthDay`=?,`address`=?,`userName`=?,`password`=? where `mobile`=?";
        try{
            ps=myConnection.getconnection().prepareStatement(quary);
            ps.setString(1, name);
            ps.setString(11,mobile);
            ps.setString(2,gender);
            ps.setString(3,Plase);
            ps.setString(4,Lang);
